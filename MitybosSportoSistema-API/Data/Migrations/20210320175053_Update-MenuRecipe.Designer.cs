...
namespace MitybosSportoSistema_API.Data.Migrations
{
    ...
    [Migration("20210320175053_Update-MenuRecipe")]
    partial class UpdateMenuRecipe
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MitybosSportoSistema_API.Infrastructure.Database.Models.Valgiarastis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("SavaitesDiena")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SavaitesDienosSkaitineReiksme")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Valgiarasciai");
                });

            modelBuilder.Entity("MitybosSportoSistema_API.Infrastructure.Database.Models.ValgiarastisReceptas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ValgiarastisId");

                    b.ToTable("ValgiarasciaiReceptai");
                });
            ...
            modelBuilder.Entity("MitybosSportoSistema_API.Infrastructure.Database.Models.Valgiarastis", b =>
                {
                    b.HasOne("MitybosSportoSistema_API.Models.Vartotojas", null)
                        .WithMany("Valgiarasciai")
                        .HasForeignKey("VartotojasId");
                });

            modelBuilder.Entity("MitybosSportoSistema_API.Infrastructure.Database.Models.ValgiarastisReceptas", b =>
                {
                    b.HasOne("MitybosSportoSistema_API.Models.Receptas", "Receptas")
                        .WithMany("ValgiarastisReceptas")
                        .HasForeignKey("ReceptasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MitybosSportoSistema_API.Infrastructure.Database.Models.Valgiarastis", "Valgiarastis")
                        .WithMany("ValgiarastisReceptas")
                        .HasForeignKey("ValgiarastisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MitybosSportoSistema_API.Models.Receptas", b =>
                {
                    b.HasOne("MitybosSportoSistema_API.Models.Vartotojas", "ReceptoAutorius")
                        .WithMany("Receptai")
                        .HasForeignKey("VartotojasId");
                });
            ...
            modelBuilder.Entity("MitybosSportoSistema_API.Models.Treniruote", b =>
                {
                    b.HasOne("MitybosSportoSistema_API.Models.SportoPrograma", "SportoPrograma")
